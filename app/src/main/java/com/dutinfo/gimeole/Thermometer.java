...
public class Thermometer extends View {
    ...
    public static final float MAX_TEMP = 50, MIN_TEMP = 20;
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        outerCircleRadius = typedArray.getDimension(R.styleable.ThermometerView_maxThermometerRadius, 20f);
        int outerColor = typedArray.getColor(R.styleable.ThermometerView_maxScaleLineColor, Color.GRAY);
        int middleColor = typedArray.getColor(R.styleable.ThermometerView_midScaleLineColor, Color.WHITE);
        int innerColor = typedArray.getColor(R.styleable.ThermometerView_minScaleLineColor, Color.RED);
        ...
        graduationPaint.setTextSize(15);
